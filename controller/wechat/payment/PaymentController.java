package com.cb.controller.wechat.payment;
 ...
 * 微信端订单控制器
 */
@Controller("wechat-paymentController")
...
public class PaymentController extends CommonController {
    ...
    public String query(String code, Model model) {
        model.addAllAttributes(paymentService.result(code));
        return "/wechat/payment/result";
    }
